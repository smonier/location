...
public class MapAttributesFilter extends AbstractFilter{
    ...
    public String prepare(RenderContext renderContext, Resource resource, RenderChain chain) throws Exception {
        if(StringUtils.isNotEmpty(googleMapApiKey) && renderContext.getRequest().getAttribute(LOCATION_MAP_KEY_ATTR) == null) {
            renderContext.getRequest().setAttribute(LOCATION_MAP_KEY_ATTR, googleMapApiKey);
        }
        return null;
    }
